...
public class Main {
    ...
    public static void setupPersistence() {
        // FIXME
        Utils.join(CAPERS_FOLDER, ".capers").mkdir();
        Utils.join(CAPERS_FOLDER, ".capers", ".dogs").mkdir();
        try {
            Utils.join(CAPERS_FOLDER, ".capers", "story.txt").createNewFile();
        } catch (Exception e) {
    ...
    public static void writeStory(String[] args) {
        ...
        // FIXME
        File f = Utils.join(CAPERS_FOLDER, ".capers", "story.txt");
        String currentStory = Utils.readContentsAsString(f);
        String newStory = currentStory + "\n" + args[1];
    ...
    public static void celebrateBirthday(String[] args) {
        ...
        // FIXME
        File f = Utils.join(Dog.DOG_FOLDER, args[1]);
