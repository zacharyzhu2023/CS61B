...
public class ArraysTest {
    ...
    public void catenateTest() {
        ...
        assertArrayEquals(new int[] {2, 2, 5, 10, 11}, Arrays.catenate(new int[] {2,2}, new int[] {5, 10, 11}));
        assertArrayEquals(new int[] {1, 2, 3}, Arrays.catenate(new int []{1, 2, 3}, new int[] {}));
        assertArrayEquals(new int[] {}, Arrays.catenate(new int []{}, new int[] {}));
    }

    @Test
    public void removeTest() {
        assertArrayEquals(new int[] {1, 5, 13}, Arrays.remove(new int[] {1, 5, 6, 10, 13}, 2, 2));
        assertArrayEquals(new int[] {10, 13}, Arrays.remove(new int[] {1, 5, 6, 10, 13}, 0, 3));
        assertArrayEquals(new int[] {1, 5, 6, 10, 13}, Arrays.remove(new int[] {1, 5, 6, 10, 13}, 3, 0));
        assertArrayEquals(new int[] {1, 5, 6, 10}, Arrays.remove(new int[] {1, 5, 6, 10, 13}, 4, 1));
    }
